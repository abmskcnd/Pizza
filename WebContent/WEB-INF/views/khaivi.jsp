    ...
    <div class="row">
      ...
      <div class="col-lg-3">
        ...
        <div class="list-group">
          ...
          <a href="../user/miy.htm" class="list-group-item">Mì Ý </a>
        ...
        <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
          ...
          <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
              <img class="d-block img-fluid" src="../public/khaivi/1.png" alt="First slide"  >
            </div>
            <div class="carousel-item">
              <img class="d-block img-fluid" src="../public/khaivi/2.png" alt="Second slide"  >
            </div>
            <div class="carousel-item">
              <img class="d-block img-fluid" src="../public/khaivi/3.png" alt="Third slide" >
            </div>
          </div>
