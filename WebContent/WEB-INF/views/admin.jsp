  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="#" class="list-group-item list-group-item-action bg-light">Khách Hàng</a>
        <a href="#" class="list-group-item list-group-item-action bg-light">Món Ăn</a>
        ...
        <a href="#" class="list-group-item list-group-item-action bg-light">Doanh Thu</a>
      </div>
    </div>
    <!-- /#sidebar-wrapper -->
